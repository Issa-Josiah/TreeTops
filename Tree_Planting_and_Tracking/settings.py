"""
Django settings for Tree_Planting_and_Tracking project.
...
ROOT_URLCONF = 'Tree_Planting_and_Tracking.urls'
...
WSGI_APPLICATION = 'Tree_Planting_and_Tracking.wsgi.application'
...
MPESA_EXPRESS_SHORTCODE = os.getenv('BUSSINESS_SHORT_CODE')
